...
def generate_reply(user_message):
    return f"🧠 WiseBuddy says: {user_message[::-1]}"  # For fun: reverses user text
...
with col1:
    user_input = st.text_input("Ask me anything...", key="input_text", label_visibility="collapsed")
with col2:
...
if send and user_input.strip():
    ...
    # Bot reply
    bot_reply = generate_reply(user_input.strip())
